...
public class Application {
    public static void main(String[] args) {
        TestLoggingService service = Ioc.createTestLoggingServiceClass(new TestLoggingServiceCalculate());
        service.calculation(1);
        service.calculation(1, 2);
        service.calculation(1, 2, 3);

        TestLoggingService serviceSecondary = Ioc.createTestLoggingServiceClass(new TestLoggingCircuitService());
