...
import static ru.otus.crm.service.DBServiceClientFactory.HIBERNATE_CFG_FILE;
...
public class WebServerWithFilterBasedSecurityDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DBServiceClient repository = new DbServiceClientImplCache(transactionManager, clientTemplate);
